...
for Va_cnt in range(0, num_V + 2):
    ...
    while error_np > params.tolerance:
        ...
        print(f'continuity_residuals_n_vector.shape = {continuity_residuals_n_vector.shape}\ncontinuity_residuals_p_vector.shape = {continuity_residuals_p_vector.shape}\npossion_residuals_vector.shape = {possion_residuals_vector.shape}')
