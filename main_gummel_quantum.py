...
results_dir = os.path.join("results_Gummel", timestamp + f'e_i_{params.w_i}')
if not os.path.exists("results_Gummel"):
    os.mkdir("results_Gummel")
...
for Va_cnt in range(0, num_V + 2):
    ...
    while error_np > params.tolerance:
        ...
        if it > 0:
            ...
            error_np = min(continuity_residuals_n, continuity_residuals_p, possion_residuals, old_error_np)
